...
| ------------------          | :--:            | :--:      |  :--:     |  :--:    |     :--:      |      :--:      |        :--:         |       :--:           | 
|dicotIncConf_100_50k.json // |   469.043s      |  766s     |  1235s    |  574s    |    97 212     |    459 073     |    2 209 199        |        4 711 701     |
| dicotIncConf_50_50k.json // |   266.401s      |  148s     |   414s    |  352s    |    72 627     |    370 596     |    1 193 834        |        3 041 768     |
| dicotIncConf_10_50k.json // |   126.465s      |   87s     |   214s    |  220s    |    53 247     |    301 034     |      386 829        |        1 713 594     |
| dicotIncConf_0_50k.json  // |    76.247s      |  1.4s     |    78s    |  160s    |    48 605     |    284 732     |       46 766        |        1 097 073     |
|-----------------------------|-----------------|-----------|-----------|----------|---------------|----------------|---------------------|----------------------|
| dicotIncConf_0_25k.json  // |    30.764s      |    1s     |    32s    |   76s    |    24 022     |    139 019     |       24 935        |          613 779     |
|-----------------------------|-----------------|-----------|-----------|----------|---------------|----------------|---------------------|----------------------|
| dicotIncConf_0_10k.json  // |    13.666s      |  0.7s     |    14s    |   42s    |     9 337     |     47 614     |       13 278        |          344 713     |
|-----------------------------|-----------------|-----------|-----------|----------|---------------|----------------|---------------------|----------------------|
| dicotIncConf_100_5k.json // |     47.886s     |   110s    |   158s    |   78s    |     9 284     |     40 339     |      348 999        |          816 094     |
| dicotIncConf_50_5k.json  // |     29.648s     |   112s    |   142s    |   57s    |     6 838     |     32 217     |      185 222        |          557 083     |
| dicotIncConf_10_5k.json  // |     10.494s     |   2.2s    |    13s    |   29s    |     5 073     |     25 680     |       23 081        |          227 496     |
| dicotIncConf_0_5k.json   // |     12.683s     |   0.6s    |    13s    |   25s    |     4 642     |     24 037     |        7 175        |          199 573     |





data_loading for 0_5k is 6s while for 10_5k was 0.8s ?
