...
#with open('.\..\..\Data_Json\Dictionnary\\12Dico.json', 'r') as f:		# 0.0 s vs 466.17 s (8min)	vs 0.0 s	|| 2.31822  vs 2.34025 vs 2.34025
#with open('.\..\..\Data_Json\Dictionnary\\11Dico.json', 'r') as f:		# 0.0 s vs 21.169 s		vs 0.0 s	|| 2.08734  vs 2.10937 vs 2.10937 
#with open('.\..\..\Data_Json\Dictionnary\\10Dico.json', 'r') as f:		# 0.0 s vs 5.195 s 		vs 0.0 s	|| 0.86158  vs 1.31749 vs 1.317489
    dico = json.load(f)
