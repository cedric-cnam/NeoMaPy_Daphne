...
data_conf = '.\..\..\Data_Json\Initial_Data\\tInc_conflicts_0_5k_nrockit.json'
with open(data_conf, 'r') as f:
    liste_conf = json.load(f)


# Give your initial json file containing the non conflicting nodes
data_noconf = '.\..\..\Data_Json\Initial_Data\\tInc_noConflicts_0_5k_nrockit.json'
...
fichier_conf = open("dicotIncConf_0_5k_nrockit.json", "w")
fichier_conf.write("{\n")
size = len(dico_conf)
i = 1
...
fichier_noconf = open("dicotIncNoConf_0_5k_nrockit.json", "w")
