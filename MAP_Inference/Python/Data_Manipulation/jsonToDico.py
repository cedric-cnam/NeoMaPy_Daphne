...
data_conf = '.\..\..\Data_Json\Initial_Data\\tInc_conflicts_100_25k.json'
with open(data_conf, 'r') as f:
    liste_conf = json.load(f)


# Give your initial json file containing the non conflicting nodes
data_noconf = '.\..\..\Data_Json\Initial_Data\\tInc_noConflicts_100_25k.json'
...
fichier_conf = open("dicotIncConf_100_25k.json", "w")
fichier_conf.write("{\n")
size = len(dico_conf)
i = 1
...
fichier_noconf = open("dicotIncNoConf_100_25k.json", "w")
