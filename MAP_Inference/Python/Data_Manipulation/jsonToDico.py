...
fichier_conf = open("dicoConf_0_5k_SansC0.json", "w")
fichier_conf.write("{\n")
size = len(dico_conf)
i = 1
...
fichier_noconf = open("dicoNoConf_0_5k_SansC0.json", "w")
