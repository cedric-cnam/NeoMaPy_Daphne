...
//TF links
MATCH (tf:TF) RETURN tf.ID as Node_id, tf.date_start as date_start, tf.date_end as date_end, tf.s as s, tf.o as o, tf.p as p, tf.polarity as polarity, tf.valid as valid, tf.weight as weight;
