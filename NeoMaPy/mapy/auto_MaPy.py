...
# Creation of the dictionary of non conflicting nodes where (key,value) is ('id' : [weight, []])
dico_noconf = {}
...
fichier_conf = open(outputFolder+"dicoConf.json", "w")
fichier_conf.write("{\n")
size = len(dico_conf)
i = 1
...
# Creation of the json file of this dictionary of non conflicting nodes
fichier_noconf = open(outputFolder+"dicoNoConf.json", "w")
...
#start = time.time()
data_conf = outputFolder+'dicoConf.json'
...
fichier = open(outputFolder+"listOfDico.json", "w")
...
if __name__ == '__main__':
    with open(outputFolder+'dicoNoConf.json', 'r') as f:
        dico = json.load(f)

    #with open('./../../Data_Json\Dictionnary\listDico\listOfDicotInc_25_200k.json', 'r') as f:
    with open(outputFolder+'listOfDico.json', 'r') as f:
        l_dico = json.load(f)
    ...
    fichier = open(outputFolder+"solutions_MaPy.txt", "w")
    for id in dico:
    ...
    fichier = open(outputFolder+"statistics_MaPy.txt", "w")
