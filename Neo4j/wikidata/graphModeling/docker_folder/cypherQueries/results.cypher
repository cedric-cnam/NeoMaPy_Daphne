...
RETURN id(tf1) as Node_id, tf1.ID as wikiID, s.ID as s, o.ID as o, p.ID as p, tf1.weight AS weight, apoc.temporal.format(tf1.date_start, "yyyyMM") as start_date, apoc.temporal.format(tf1.date_end, "yyyyMM") as end_date, tf1.polarity as polarity
